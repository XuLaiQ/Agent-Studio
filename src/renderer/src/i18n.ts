...
const messages: Record<Locale, Dict> = {
  en: {
    ...
    'settings.pageSubtitle': 'Configure appearance, language, and agent settings',
    ...
    'projects.runtime.busy': 'Executing',
    'projects.runtime.ready': 'Ready',
    'projects.runtime.stopped': 'Stopped',
    'projects.runtime.error': 'Error',
    'projects.summary.busy': '{count} active',
    'projects.summary.ready': '{count} ready',
    'projects.summary.stopped': '{count} stopped',
    'projects.summary.error': '{count} error',
    'projects.summary.none': 'No agents',
    ...
    'explorer.rename.prompt': 'Enter a new name.',
    'explorer.rename.done': 'Renamed',
    ...
    'version.commitFiles.empty': 'No files in this commit.',
    'version.commitFiles.loading': 'Loading files...',
    ...
    'tokens.scope': 'All local usage records',
    'tokens.loading': 'Calculating token usage...',
    'tokens.empty': 'No token usage recorded yet. Run an agent to start tracking.',
    'tokens.noAgentUsage': 'No usage recorded for this agent yet.',
    'tokens.unsupported': 'Usage tracking is not available for this agent yet.',
    'tokens.input': 'Input',
    'tokens.output': 'Output',
    'tokens.cacheWrite': 'Cache write',
    'tokens.cacheRead': 'Cache read',
    'tokens.messages': 'Responses',
    'tokens.dashboardTitle': 'Token Usage',
    'tokens.dashboardSubtitle': 'Cumulative agent token usage from local CLI history',
    'tokens.byModel': 'Tokens by model',
    'tokens.composition': 'Token composition',
    'tokens.compositionByModel': 'Composition by model',
    'tokens.byAgent': 'Tokens by agent',
    'tokens.modelsTracked': 'Models tracked',
    'tokens.agentsTracked': '{count} agent types',
    'tokens.details': 'Breakdown',
    'tokens.model': 'Model',
    'tokens.agent': 'Agent',
    ...
    'terminal.effort': 'Effort',
    'terminal.speed': 'Speed',
    'terminal.default': 'Default',
    'terminal.standard': 'Standard',
    'terminal.launchSettingsPending': 'Restart or resume the CLI to apply this setting',
    ...
    'orchestrator.autoExecute': 'Auto-execute after planning',
  ...
  zh: {
    ...
    'orchestrator.autoExecute': '计划生成后自动执行',
...
const zhFallbackMessages: Dict = {
  'settings.title': '\u8bbe\u7f6e',
  'settings.pageSubtitle': '\u914d\u7f6e\u5916\u89c2\u3001\u8bed\u8a00\u548c\u667a\u80fd\u4f53\u8bbe\u7f6e',
  ...
  'common.save': '\u4fdd\u5b58',
  'terminal.effort': '\u63a8\u7406\u5f3a\u5ea6',
  'terminal.speed': '\u901f\u5ea6',
  'terminal.default': '\u9ed8\u8ba4',
  'terminal.standard': '\u6807\u51c6',
  'terminal.launchSettingsPending': '\u91cd\u542f\u6216\u6062\u590d CLI \u540e\u751f\u6548',
  ...
  'explorer.rename': '\u91cd\u547d\u540d',
  'explorer.rename.prompt': '\u8f93\u5165\u65b0\u540d\u79f0\u3002',
  'explorer.rename.done': '\u5df2\u91cd\u547d\u540d',
  'preview.title': '\u6587\u4ef6\u9884\u89c8',
  ...
  'projects.runtime.busy': '执行中',
  'projects.runtime.ready': '就绪',
  'projects.runtime.stopped': '已停止',
  'projects.runtime.error': '出错',
  'projects.summary.busy': '{count} 执行',
  'projects.summary.ready': '{count} 就绪',
  'projects.summary.stopped': '{count} 停止',
  'projects.summary.error': '{count} 错误',
  'projects.summary.none': '无 Agent',
  ...
  'version.commitFiles.empty': '该提交没有文件。',
  'version.commitFiles.loading': '正在加载文件...',
  ...
  'tokens.allTime': '总量',
  'tokens.refresh': '刷新',
  'tokens.total': 'TOKEN 总量',
  'tokens.scope': '所有本地使用记录',
  'tokens.loading': '正在统计 TOKEN 用量...',
  'tokens.empty': '暂无 TOKEN 用量记录。运行 Agent 后即可开始统计。',
  'tokens.noAgentUsage': '该 Agent 暂无用量记录。',
  'tokens.unsupported': '该 Agent 暂不支持用量统计。',
  'tokens.input': '输入',
  'tokens.output': '输出',
  'tokens.cacheWrite': '缓存写入',
  'tokens.cacheRead': '缓存读取',
  'tokens.messages': '回复数',
  'tokens.dashboardTitle': 'TOKEN 用量',
  'tokens.dashboardSubtitle': '来自本地 CLI 历史的累计 Agent TOKEN 用量',
  'tokens.byModel': '各模型 TOKEN 量',
  'tokens.composition': 'TOKEN 构成',
  'tokens.compositionByModel': '各模型 TOKEN 构成',
  'tokens.byAgent': '各 Agent TOKEN 量',
  'tokens.modelsTracked': '已统计模型',
  'tokens.agentsTracked': '{count} 种 Agent',
  'tokens.details': '明细',
  'tokens.model': '模型',
  'tokens.agent': 'Agent',
  'tokens.allModels': '全部模型'
}
