...
const messages: Record<Locale, Dict> = {
  en: {
    ...
    'tokens.projects': 'Across {count} projects',
    ...
    'tokens.dashboardSubtitle': 'Cumulative agent token usage across all projects',
...
const zhFallbackMessages: Dict = {
  ...
  'tokens.dashboardSubtitle': '所有项目累计的 Agent 令牌用量',
