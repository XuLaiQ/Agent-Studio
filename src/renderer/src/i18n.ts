...
const zhFallbackMessages: Dict = {
  ...
  'tokens.loading': '正在统计令牌用量...',
  'tokens.empty': '暂无令牌用量记录。运行 Agent 后即可开始统计。',
  ...
  'tokens.messages': '回复数',
  'tokens.dashboardTitle': '令牌用量',
  'tokens.dashboardSubtitle': '来自本地 CLI 历史的累计 Agent 令牌用量',
  'tokens.byModel': '各模型令牌量',
  'tokens.composition': '令牌构成',
  'tokens.compositionByModel': '各模型令牌构成',
  'tokens.byAgent': '各 Agent 令牌量',
